...
class WaterMarkVisibilitySelector extends ConsumerWidget {
  const WaterMarkVisibilitySelector({super.key});
    ...
    return Row(
      ...
      children: [
        Padding(
          ...
          child: 'Watermark'.txt(size: 12, color: grey400),
        ),
        Container(
          width: 150,
          height: 35,
          ...
          child: Stack(
            children: [
              Padding(
                ...
                child: AnimatedAlign(
                  alignment: switch (editorState.waterMark) {
                ...
                child: CustomizableRow(
                  ...
                  children: [
                    Center(child: 'Yes'.txt()).tap(
                      onTap: () {
                        editorStateNotifier.toggleWaterMark();
                      },
                    ),
